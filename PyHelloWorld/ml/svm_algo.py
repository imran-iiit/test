"""
    ...
    Sequential Minimal Optimization book: http://research.microsoft.com/pubs/68...
...
class Support_Vector_Machine:
    def __init__(self, visualization=True):
        ...
        if self.visualization:
            self.fig = plt.figure()
            self.ax = self.fig.add_subplot(1, 1, 1) # Figure of size 1, 1 with location in it at 1
    # train
    def fit(self, data):
        self.data = data
        # { ||w||: [w,b] }
